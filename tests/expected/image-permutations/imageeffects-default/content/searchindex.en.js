var relearn_searchindex = [
  ...
  {
    "breadcrumb": "Image Permutations",
    "content": "Formats Hugo can read dimensions from some image resources and not from others. Both kinds are here, sized identically, so the difference is the resource and nothing else.\nMeasurable Unmeasurable Inlined inlinecontent replaces the element entirely, and strips the XML declaration on the way.\ninlinecontent on anything else is ignored.\nEmbedded",
    "description": "Formats Hugo can read dimensions from some image resources and not from others. Both kinds are here, sized identically, so the difference is the resource and nothing else.\nMeasurable",
    "tags": [],
    "title": "Formats",
  ...
  {
    "breadcrumb": "Image Permutations",
    "content": "Template The theme documents calling its image partial from a template, passing effects as attributes. That is the highest layer of the effect stack, above the URL, the front matter and the site configuration - and the only layer that can hand the partial an HTML attribute directly.\nA fixture-local shortcode makes the call, so these are template calls rather than markdown images.\nNothing passed Effect classes Unknown classes Effect names are consumed; anything else is passed through to the element.\nAttributes the element carries Outranking the URL",
    "description": "Template The theme documents calling its image partial from a template, passing effects as attributes. That is the highest layer of the effect stack, above the URL, the front matter and the site configuration - and the only layer that can hand the partial an HTML attribute directly.\nA fixture-local shortcode makes the call, so these are template calls rather than markdown images.",
    "tags": [],
    "title": "Template",
